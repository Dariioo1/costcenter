...
onSelectNode: function (oEvent) {
    ...
    console.log(
        oContext.getObject().name +
        (bSelected ? " seleccionado" : " deseleccionado")
    );
},
getSelectedNodes: function () {
    ...
    this._collectSelectedNodes(
        this.getView().getModel().getProperty("/nodes"),
        aSelected
    );
...
_collectSelectedNodes: function (aNodes, aSelected) {
